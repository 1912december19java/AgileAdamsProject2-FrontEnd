(function(global, factory) {
...
}(this, (function(exports, core, common, D3) {
    'use strict';
    ...
    var AgWordCloudDirective = (function() {
        ...
        function AgWordCloudDirective(element) {
            this.temp = [];
            this.color = ['#2BAAE2', '#615550', '#BC243C', '#003E5D', '#22BAA0', '#cecece', '#FF6F61', '#6B5B95', '#77212E', '#F96714'];
        ...
        AgWordCloudDirective.prototype.drawWordCloud = function(words) {
            ...
            this.svg
                ...
                .on('mouseover', function(d, i) {
                    return _this.options.labels ? tooltip.style('visibility', 'visible').text('Count: ' + self.getWordSize(d.text)) : tooltip.style('display', 'none');
                })
     ...
     * @nocollapse
     */
    AgWordCloudDirective.ctorParameters = function() {
        return [
